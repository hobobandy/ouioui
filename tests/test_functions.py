...
class TestFunctions(unittest.TestCase):
  ...
  def test4_from_args(self):
    ...
    args = argparse.Namespace(debug=False, config=test_config_path, query="AA:BB:CC")
    ...
    args = argparse.Namespace(debug=False, config=test_config_path, package_for_kismet=True)
    ouioui.from_args(args)
